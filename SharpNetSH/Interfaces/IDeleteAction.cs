...
namespace Ignite.SharpNetSH
{
	public interface IDeleteAction
	{
		...
		void Cache(String url, Boolean? recursive = null);
		...
		/// </summary>
		/// <param name="address">Specifies the IPv4 or IPv6 address to be deleted from the IP listen list.</param>
		void IpListen(String address = null);
		...
		/// </summary>
		/// <param name="ipAddress">Specifies the IPv4 or IPv6 address and port for which the SSL certificate bindings will be deleted.</param>
		...
		void Timeout(Timeout? timeoutType = null);
